# Ai Agent学习记录02\-多工具的调用

上一个按钮做的是 创建一个用来查询天气的tool，但是如果是多个tools呢？AI又会怎么调用与执行呢？

在代码里面添加了查询新闻\(get\_latest\_news\)与航班的\(get\_flight\_status\)tools,并且对提示词做了修改：
...
--- 测试天气查询 ---
今天黄冈的天气是多云，气温为31.3°C，风速约为7.6 km/h，体感较热，建议注意防暑降温，外出可适当遮阳。

--- 测试新闻查询 ---
目前暂时没有检索到关于“人工智能”的最新新闻。可能是因为近期相关资讯较少，或者关键词匹配未覆盖最新动态。如果您有更具体的关注方向（例如某家公司、某项技术突破或政策动向），欢迎告诉我，我可以帮您进一步查找！

--- 测试航班查询 ---
抱歉，查询航班状态时网络连接出现了问题，暂时无法获取 CA183 航班的实时信息。您可以稍后重试，或提供更具体的出发/到达城市，我可帮您进一步查询其他相关信息。
```
